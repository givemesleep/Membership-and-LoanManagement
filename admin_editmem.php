                        ...
                        <fieldset <?php echo ($flags != '') ? $prev : '' ?>>  
                            ...
                            <div class="accordion accordion-flush" id="accordionFlushExample">
                                ...
                                <div class="col-md-12 text-center">
                                    <hr>
                                    <i class="icon text-dark bi bi-person-fill"></i>&nbsp;<i class="icon text-secondary bi bi-dash-lg"></i>
                                    <i class="icon text-secondary bi bi-geo-alt-fill"></i>&nbsp;<i class="icon text-secondary bi bi-dash-lg"></i>
                                    <i class="icon text-secondary bi bi-person-lines-fill"></i>&nbsp;<i class="icon text-secondary bi bi-dash-lg"></i>
                                    <i class="icon text-secondary bi bi-info-square-fill"></i>
                                </div>
