  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title" style="font-size: 35px;"><b>Active Loan</b></h5>
              <table class="table datatable table-hover">
                <thead style="width : 100%">
                    <tr>
                        <th scope="col" style="width: 5%;">#</th>
                        <th scope="col" style="width: 25%;">Member Name</th>
                        <th scope="col"  style="width: 15%;">Loan Type</th>
                        <th scope="col"  style="width: 15%;" >Next Payment</th>
                        <th scope="col"  style="width: 15%;" class="text-end">Loan Amount</th>
                        <th scope="col"  style="width: 15%;" class="text-end">Balance</th>
                        <th scope="col"  style="width: 15%;" class="text-end">Compensate</th>
                ...
                <tbody>                                    
                    ...
                    <?php 
                      ...
                      while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                        $btn = '
                        <a href="admin_lnactview.php?mem='.encrypt($row['memID'], $key).'"><button class="btn btn-dark" title="View"><i class="ri-eye-fill"></i></button></a>';
                        $newAm = $row['Balance'] - $row['Paid'];
                        // $newBal = $row['Balance'] - $row['Paid'];
                        $disp .= '<tr>
                                    <td>'.$count.'</td>
                                    <td>'.$row['Fullname'].'</td>
                                    <td>'.$row['Loan_Type'].'</td>
                                    ...
                                    <td class="text-end">&#x20B1; '.number_format($newAm, "2", ".", ",").'</td>
...
//starting
<?php 
if(isset($_SESSION['actVal'])){
    ?>Swal.fire({
        position: 'center',
        icon: 'success',
        title: 'Application Approved!',
        text: '<?php echo $_SESSION['actVal'] ?>',
        timer: 5500
    });    

<?php unset($_SESSION['actVal']); } ?>
//ending

<?php 
if(isset($_SESSION['actErr'])){
    ?>Swal.fire({
        position: 'center',
        icon: 'danger',
        title: 'Transaction Error!',
        text: '<?php echo $_SESSION['actErr'] ?>',
        timer: 5500
    });    

<?php unset($_SESSION['actErr']); } ?>
