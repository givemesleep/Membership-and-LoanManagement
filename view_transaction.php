              ...
              <fieldset class="active">
                ...
                <!-- heading -->
                  ...
                  <div class="col-md-3 mt-4">
                    ...
                    <!-- search list  -->
                    <ol class="list-group list-group-numbered mb-3" id="itemList" style="position: absolute; z-index: 1000; background-color: white; ">
                    <?php 
                      $sqlbg = "SELECT 
                            un.unID AS ID, p.memberID AS memID, p.memNick AS Nickname,
                            CONCAT(p.memGiven, ' ', p.memSur) AS Fullname,
                      ...
                      if($stmtbg->rowCount() > 0){
                        while($rowbg=$stmtbg->fetch()){
                          $list.='
                            <a href="admin_viewtrans.php?res=Deposit&mem=' . $rowbg['memID'] . '">
                            <li class="list-group-item" style="font-size: 13px; border: none; " title="Click to view '.$rowbg['Nickname'].' Deposit/Loan.">Name : <b>'.$rowbg['Fullname'].'</b><br>ID : <b>'.$rowbg['ID'].'</b> </li>
                            </a>
                          ';
                        }
                        ...
                        <div class="card-body" style="border: 1px solid;">
                          <div class="row">
                            <div class="col-md-12 mt-3">
                              <img src="assets/img/llampcologo.jpg" class="img-fluid" alt="..." style="max-width: 100%; height: 150px;">
                            </div>
                    ...
                    <div class="card" style="height: 120px; border: 1px solid;">
                      <div class="card-body">
                        <div class="row mt-3">
                          ...
                          <div class="col-md-3">
                            <img src="assets/img/llampcologo.jpg" class="img-fluid" alt="..." style="max-width: 100%; height: 100px;">
                          </div>
