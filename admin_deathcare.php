...
<?php 
  ...
  $pages = 'deathcare';  $nav = ''; require_once 'sidenavs/admin_side.php';
?>
  ...
  <div class="pagetitle">
      ...
      <nav>
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Death Care Renewal</li>
  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title" style="font-size: 35px;"><b>Death Care Renewal</b></h5>
              <table class="table table-hover datatable" id="myTable">
                <thead style="width : 100%;">
                    <tr>
                        ...
                        <th scope="col"  style="width: 10%;">Avail On</th>
                        <th scope="col"  style="width: 10%;">Expire On</th>
