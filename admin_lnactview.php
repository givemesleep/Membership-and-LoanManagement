<?php
    ...
    if(isset($_GET['mem'])){
        ...
        $sqlLoan = "SELECT loanAm AS Amount, loanTerm AS Terms, loanID AS lnID, lnApply AS lnDate, 
                    ...
                    AddedBy AS lnAssist, lnunID  AS UnID, lnTotInt AS TotInt, loanAcquire AS Acquired, loanMaturity AS Maturity, lnMonInt
                    FROM tbloaninfo
        ...
        $lnMonInt = $rowLoan['lnMonInt'];

        $out = $principal + $lnMonInt;
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mt-3">
                        <a href="admin_lnactive.php"><button class="btn btn-dark" style="opacity : 0.6;"><span class="bi bi-arrow-return-left"></span></button></a>  
                    </div>
                    ...
                    <div class="col-md-12 mt-5 text-end">
                        <a href="admin_lnviewpay.php?mem=<?php echo encrypt($memID, $key); ?>"><button class="btn btn-dark" style="width: 100%;"><i class="bi bi-receipt"></i> Loan Payments</button></a>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            <h5 class="card-title" style="font-size: 35px;"><b>Loan Application</b>&nbsp;<span class="badge text-bg-primary align-middle" ><?php echo $lnunID; ?></span></h5>
                        </div>    
                            ...
                            <div class="card" style="border: 1px solid; height: 120px; margin-top: -10px;" >
                                <div class="card-body">
                                    <div class="row mt-3">
                                        ...
                                        $intMos = $Amount * perTodec($interest);
                                        $MosPay = $Amount / $Terms;
                                        $NextPay = $MosPay + $intMos;
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <!-- <h6>&#x20B1; <?php echo number_format($totInterest, "2", ".", ",") ?> Total Interest</h6> -->
                                        </div>

                                        <div class="col-md-4">
                                            <h6>Compensate Amount</h6>
                                            <h3><b>&#x20B1; <?php echo number_format($lnTotPay, "2", ".", ","); ?></b></h3>
                                        </div>
                                        
                                        <div class="col-md-4">
                                            <h6>Next Payment</h6>
                                            <h3><b>&#x20B1; <?php echo number_format($NextPay, "2", ".", ","); ?></b></h3>
                                            <h6>&#x20B1; <?php echo number_format($Amount * perTodec($interest), "2", ".", ",");  ?> Monthly Interest</h6>
                                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" style="margin-top: -10px;">
                                <li class="nav-item" role="presentation">
                                    <button style="background: none;" class="nav-link active text-dark" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#basic" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Loan Details</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button style="background: none;" class="nav-link text-dark" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#education" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">Member Details</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button style="background: none;" class="nav-link text-dark" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#amortization" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Amortization Schedule</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button style="background: none;" class="nav-link text-dark" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#contact" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Application Details</button>
                                </li>
                                <li class="nav-item" role="presentation">
                            ...
                            <div class="tab-content pt-2" id="myTabContent">
                                        ...
                                        <div class="col-md-6 text-start">
                                            <div class="row">
                                                <div class="col-md-5 text-start">
                                                    ...
                                                    <h6>Original Amount</h6>
                                                    <h6>Interest Rate</h6>
                                                    <h6>Principal Debt</h6>
                                                    <h6>Next Payment</h6>
                                                    <h6>Interest Balance</h6>
                                                </div>
                                                <div class="col-md-7 text-start">
                                                    <h6><b></b></h6>
                                                    <h6><b>&#x20B1; <?php echo number_format($lnHanded, "2", ".", ",") ?></b></h6>
                                                    <h6><b>&#x20B1; <?php echo number_format($Amount, "2", ".", ",") ?></b></h6>
                                                    <h6><b><?php echo $interest; ?>% Diminishing Balance</b></h6>
                                                    <h6><b>&#x20B1; <?php echo number_format($totAmount, "2", ".", ","); ?></b></h6>
                                                    <h6><b>&#x20B1; <?php echo number_format($MosPay, "2", ".", ","); ?></b></h6>
                                                    <h6><b>&#x20B1; <?php echo number_format($intMos, "2", ".", ","); ?></b></h6>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 text-start">
                                            <div class="row">
                                                <div class="col-md-5 text-start">
                                                    ...
                                                    <h6>Issued Date</h6>
                                                    <h6>Maturity Date</h6>
                                                    <h6>Overdue Penalty</h6>
                                                </div>
                                                <div class="col-md-7 text-start">
                                                    <h6><b><?php echo $Terms ?> Months</b></h6>
                                                    <h6><b><?php echo $lnAcquired; ?></b></h6>
                                                    <h6><b><?php echo $lnMaturity; ?></b></h6>
                                                    <h6></h6>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="amortization" role="tabpanel" aria-labelledby="contact-tab">
                                    <h5 class="card-title" style="font-size : 20px; margin-top: -30px;"><b>Amortization Schedule</b></h5>
                                    <div class="row">  

                                        <div class="col-md-12 text-end" style="margin-top: -55px;">
                                            <!-- <a href="" ><button class="btn btn-dark" >Print Schedule</button></a> -->
                                        </div>
                                        ...
                                        <table class="table table-bordered table-hovered mt-3">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Principal</th>
                                                    <th>Interest <?php echo $interest; ?>%</th>
                                                    <th>Total</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php 
                                                    ...
                                                    foreach($amort as $values){
                                                        echo '<tr>';
                                                        echo '<td>'.$values['due'].'</td>';
                                                        echo '<td>&#x20B1; '.number_format($values['balance'], "2", ".", ",").'</td>';
                                                        echo '<td>&#x20B1; '.number_format($values['principal'], "2", ".", ",").'</td>';
                                                        echo '<td>&#x20B1; '.number_format($values['interest'], "2", ".", ",").'</td>';
                                                        echo '<td>&#x20B1; '.number_format($values['total'], "2", ".", ",").'</td>';
                                                        echo '</tr>'; 
                                                    }
                                                    echo '<tr>';
                                                    echo '<td class="text-start"><b>Total</b></td>';
                                                    echo '<td class="text-start"><b>&nbsp;</b></td>';
                                                    echo '<td>&#x20B1; '.number_format($Amount, "2", ".", ",").'</td>';
                                                    echo '<td>&#x20B1; '.number_format($totInterest, "2", ".", ",").'</td>';
                                                    echo '<td>&#x20B1; '.number_format($totAmount, "2", ".", ",").'</td>';
                                                    echo '</tr>';
                                                ?>
                                            </tbody>
                                        </table>
                                ...
                                <div class="tab-pane fade " id="contact" role="tabpanel" aria-labelledby="profile-tab">
                                    <h5 class="card-title" style="font-size : 20px; margin-top: -30px;"><b>Application Details</b></h5>
                                    <div class="row">
