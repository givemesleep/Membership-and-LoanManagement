...
<?php 
  ...
  $pages = 'pendLoan';  $nav = 'loantrans'; require_once 'sidenavs/admin_side.php';
?>
  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title" style="font-size: 25px;"><b>Pending Loans</b></h5>
            <br>
                <table class="table datatable table-hover" style="width: 100%;">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" style="width: 20%;">Loan Amount</th>
                    ...
                    <tbody>                                    
                        <?php
                            ...
                            // $btn='
                            //     <a href=".php"><button class="btn btn-dark"><i class="ri-eye-fill"></i><span> View</span></button></a>
                            //     <a href="mem_procpmes.php?pmesID=' . $rows['ID'] . '"><button class="btn btn-success"><i class="ri-checkbox-circle-fill"></i><span> Approve</span></button></a>
                            //     <a href=".php"><button class="btn btn-danger"><i class="ri-close-circle-fill"></i><span> Reject</span></button></a>
                            //     ';
