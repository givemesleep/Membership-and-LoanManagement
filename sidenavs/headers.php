<header id="header" class="header fixed-top d-flex align-items-center">
  ...
  ?>
    <div class="d-flex align-items-center justify-content-between">
      <i class="bi bi-list toggle-sidebar-btn" style="margin-left: -20px; margin-right: 20px"></i>
      ...
      <div class="col-md-12 card-title" style="font-size: 25px; margin-top: -5px;">LLANO MULTI-PURPOSE COOPERATIVE</div>
    </div><!-- End Logo -->
