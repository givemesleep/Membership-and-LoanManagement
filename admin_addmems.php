        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="card">
                    ...
                    <form action="process/" method="post" id="multiStepForm">
...
<script>
    ...
    function nextStep(stepChange) {
        const currentForm = steps[currentStep].querySelector('input, select');
        if (stepChange > 0) {
            if (currentForm.checkValidity()) {
                currentForm.classList.remove('invalid');
                currentForm.classList.add('valid');
                currentStep += stepChange;
                showStep(currentStep);
            } else {
                currentForm.classList.remove('valid');
                currentForm.classList.add('invalid');
