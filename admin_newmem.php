...
<main id="newmain" class="main">
    <div class="pagetitle mt-3" style="margin-left: 30px;">
      <h1>Membership Data Entry</h1>
      <nav>
          <ol class="breadcrumb">
        ...
        <div class="row g-3">
            ...
            <div class="col-lg-3 row fs-6">
                            ...
                            <div class="steps">
                                ...
                                <div class="stepInfo">
                                    ...
                                    <span style="font-size:50px; margin-left:15px;margin-top:-10px;"><i class="bi bi-person-circle <?php echo ($flags == '' || $flags == 1) ? 'active' : '' ?>"></i></span>
                                    <div class="stepName">
                                        <p class="label <?php echo ($flags == '' || $flags == 1) ? 'active' : '' ?>" style="font-weight:bold;">PERSONAL INFORMATION</p>
                                    </div>
                                    </div>
                                    ...
                                    <span style="font-size:50px; margin-left:15px;margin-top:-10px;"><i class="bi bi-person-vcard-fill <?php echo ($flags == 2) ? 'active' : '' ?>"></i></span>
                                    <div class="stepName">
                                        <p class="label <?php echo ($flags == 2) ? 'active' : '' ?>" style="font-weight:bold;">IDENTIFIABLE INFORMATION</p>
                                    </div>
                                    </div>
                                    ...
                                    <span style="font-size:50px; margin-left:15px;margin-top:-10px;"><i class="bi bi-buildings-fill <?php echo ($flags == 3) ? 'active' : '' ?>"></i></span>
                                    <div class="stepName">
                                        <p class="label <?php echo ($flags == 3) ? 'active' : '' ?>" style="font-weight:bold;">SOCIAL BACKGROUND</p>
                                    </div>
                                    </div>

                                    <div class="stepInfo">
                                    <div class="step <?php echo ($flags == 4) ? 'bacactive' : '' ?>" data-step="4" style="font-size:20px; padding-left:3px;">4</div>
                                    <span style="font-size:50px; margin-left:15px;margin-top:-10px;"><i class="bi bi-calendar-event <?php echo ($flags == 4) ? 'active' : '' ?>"></i></span>
                                    <div class="stepName">
                                        <p class="label <?php echo ($flags == 4) ? 'active' : '' ?>" style="font-weight:bold;">PMES SCHEDULING</p>
                                    </div>
                                    </div>
            ...
            <div class="col-lg-9">
                <div class="card">
                    ...
                    <fieldset class="active" <?php echo ($flags != '') ? $basic : 'class="active"' ?>>
                        <h5 class="card-title" style="font-size: 35px;"><b>Personal Information</b></h5>
                        <form action="process/proc_newmem.php?inp=1" method="post">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control letter" name="givenname" id="" value="<?php echo $firstname; ?>" required placeholder="Given Name" style="text-transform: capitalize;" tabindex="2">
                                </div>
                                ...
                                <div class="col-md-3">
                                    <label for="floatinggen" class="form-label">Birthplace <span class="required">*</span></label>
                                        <select class="form-select inpots" name="cboSex" id="floatinggen" required tabindex="8">
                    ...
                    <fieldset class="" <?php echo ($flags != '') ? $addr : '' ?>>
                        <h5 class="card-title" style="font-size: 35px;"><b>Identifiable Information</b></h5>
                    ...
                    <fieldset class=""  <?php echo ($flags != '') ? $per : '' ?>>
                        <h5 class="card-title" style="font-size: 35px;"><b>Social Background</b></h5>
                    ...
                    <fieldset class="" <?php echo ($flags != '') ? $oth : '' ?>>
                        <h5 class="card-title" style="font-size: 35px;"><b>Pre-Membership Scheduling</b></h5>
                        <form action="process/proc_newmem.php?inp=4" method="post">
                            <!-- f6 Other Information  -->
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="col-md-4">
                                        <h6 class="mt-4" style="color:#d9d9d9"><b>Beneficiary (1)</b></h6>
                                    ...
                                    <div class="col-md-4">
                                        <h6 class="mt-4" style="color:#d9d9d9"><b>Beneficiary (2)</b></h6>
                                        <label for="floatingsss" class="form-label">Last Name <span class="required">*</span></label>
                                        <input type="text" class="form-control" name="" required  tabindex="1">
                                    </div>

                                    <div class="col-md-4">
                                        <h6 class="mt-4" style="color:#d9d9d9"><b>Beneficiary (3)</b></h6>
                                        <label for="floatingsss" class="form-label">Last Name <span class="required">*</span></label>
                                        <input type="text" class="form-control" name="" required  tabindex="1">
                                    </div>
...
<footer id="" class="footer mt-auto">
    <div class="copyright">
      &copy; Copyright <strong><span><i class="ri-code-s-slash-line"></i><span>UntitledOne</span></strong>. Llano Multi-Purpose Cooperative All Rights Reserved
    </div>   
</footer>
